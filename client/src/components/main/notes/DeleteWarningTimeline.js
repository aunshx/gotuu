...
const DeleteWarningTimeline = ({
  ...
  const noteDeletion = (noteId, eventId) => {
    deleteEvent(eventId);
    deleteNote(noteId);
    close();
    completeClose();
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: "1em" }}>
        Are you sure you want to delete this tuu? This will cause you to lose
        ...
        <div className='flex_middle' style={{ marginTop: "1.5em" }}>
          <div style={{ marginRight: "1.3em" }}>
            <button
              ...
              onClick={() => noteDeletion(noteId, eventId)}
            >
...
DeleteWarningTimeline.propTypes = {
...
export default connect(mapStateToProps, mapActionsToProps)(DeleteWarningTimeline);
